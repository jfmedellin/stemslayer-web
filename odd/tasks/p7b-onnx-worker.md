...
P7B-01 is closed. Continuing work moves to P7B-02 (`OnnxSessionManager`: WebGPU-first provider selection with a tested WASM fallback) against the two synthetic fixtures committed here.
